...
#define PIOdata_fpga_MTL                fpga_mtc2
#define PIOdirection_fpga_MTL           fpga_mtc2 + PIOdirection
#define PIOinterruptmask_fpga_MTL       fpga_mtc2 + PIOinterruptmask
#define PIOedgecapture_fpga_MTL         fpga_mtc2 + PIOedgecapture
