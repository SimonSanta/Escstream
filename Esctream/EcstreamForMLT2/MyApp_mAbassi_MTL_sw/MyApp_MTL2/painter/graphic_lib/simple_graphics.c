...
vid_text_scroll_struct* vid_scroll_string_init(int hbegin, int vbegin, int hend, int f_color, int b_color, char* font, int ms_delay, char *string)
{
  ...
  scroll->ticks_at_last_move = alt_globaltmr_get64();
...
{
	if(horiz_start>horiz_end | vert_start > vert_end){
		printf("bad dimension in vid_draw_box");
		return -1;
	}
...
*  Function: max2
*
*  Purpose:  Returns the maximum value of 3 parameters
