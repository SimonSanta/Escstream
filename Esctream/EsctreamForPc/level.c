...
void new_player(LVL* level,int offset, int start_x, int start_y, int fin_x, int fin_y, bool color){
...
void new_line(LVL* level,int offset,int x, int y, int width, int height, DIR dir, bool color){
